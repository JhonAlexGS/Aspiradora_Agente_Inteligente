...
class Aspiradora():
    ...
    def mover_aspiradora(self, canvas, text_id, y_cleaner, x_cleaner, tamaño_casilla, lista_suciedades, nodoAnterior= None, delay=1000):
                ...
                for casillas in self.lista_Casillas:
                    if self.lista_Casillas != 1:
                        if casillas.id_Casilla == nodoAnterior.id_Casilla:
                            posicion_Lista_Anterior_Actual.append(index_casilla)
                            break
                    index_casilla+=1
